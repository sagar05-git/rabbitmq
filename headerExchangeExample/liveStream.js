...
const liveStreamConsumer=async(headers)=>{
    try{
        let connection;
        let channel;
        ...
        channel.consume(queue.queue,(msg)=>{
            if(msg){
                ...
                console.log("✅ Live Stream Notification received:",data);
                channel.ack(msg);
            }   
        }
    );
...
liveStreamConsumer({"x-match":"all",notificationType:"live_stream",contentType:"live_stream"
});